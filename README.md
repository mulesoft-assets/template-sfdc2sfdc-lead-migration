...
+ The endpoint is configured as a *request-response* since as a result of calling it the response will be the total of Leads migrated and filtered by the criteria specified.<!-- Default Endpoints XML (end) -->
